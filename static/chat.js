// static/chat.js - attachments as links, fixed alignment & scroll
(() => {
...
function addSystemNotice(text){
  ...
  function handleServerData(data){
    ...
    if(obj && obj.type){
      if(obj.type === "join"){
        ...
        const mine = username && obj.name === username;
        // always show as safe download link (no inline preview)
  ...
  // Mobile viewport height fix to handle keyboard resizing
